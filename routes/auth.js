...
let { SignUpValidator, LoginValidator, ChangePasswordValidator, validate } = require('../utils/validator')
...
router.post('/login', LoginValidator, validate, async function (req, res, next) {
    try {
        ...
        let token = jwt.sign({ id: user_id, exp: exp }, constants.SECRET_KEY);
...
router.get('/logout', function (req, res, next) {
    CreateCookieResponse(res, 'token', "", Date.now()); // Xoá token
